...
test1.3$vac_grp     	==	test1.4$vac_grp
test1.3$con_grp     	==	test1.4$con_grp
test1.3$nboot       	==	test1.4$nboot
test1.3$rng         	==	test1.4$rng
test1.3$seed        	==	test1.4$seed

test2.3$alpha == test2.4$alpha
test2.3$vac_grp == test2.4$vac_grp
test2.3$con_grp == test2.4$con_grp
...
test3.3$vac_grp == test3.4$vac_grp
test3.3$con_grp == test3.4$con_grp
...
test4.3$vac_grp == test4.3$vac_grp
test4.3$con_grp == test4.3$con_grp
