...
test_that("output", {
  ...
  expect_identical(names(test11), c('mfnest_details', 'mfnest_summary'))
  ##mfnest_details
  expect_equal(dim(test11$mfnest_details), c(87601, 8))
  ...
  expect_equal(test11$mfnest_summary$median, c(0.83333, rep(1, 12)), tolerance = 0.0001)
  expect_equal(test11$mfnest_summary$etlower, c(0.5, -.5, 
          rep(-1, 6), -0.308333, -0.5, -1, -0.5, -1), tolerance = 0.0001)
})
