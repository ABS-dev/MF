...
a [mfcluster](https://abs-dev.github.io/MF/reference/mfcluster-class.md)
data object

## Details

Averages the U statistic over the clusters and computes MF from it.
Clusters are excluded if they do not include both treatments.
