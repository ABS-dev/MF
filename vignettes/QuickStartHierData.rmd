...
- `vac_grp`: The name of the treatment group.
- `con_grp`: The name of the control group.
...
- `vac_grp`: The name of the treatement group.
- `con_grp`: The name of the control group
...
- `vac_grp`: User-supplied value to indicate the vaccinate group.
- `con_grp`: User-supplied value to indicate the control group.
