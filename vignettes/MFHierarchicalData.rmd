...
```{r, echo = FALSE}
thismfh <- MFh(formula = lung ~ tx + room / pen / letter, data = a)
thismfh
```
...
mfboot_multiple <- MFClusBootHier(formula = lung ~ tx + room / pen / letter, 
...
# BOOTSTRAPPING   
MFClusBootHier(formula = lung ~ tx + room / pen / letter, 
                                  data = a, boot.unit = FALSE, 
                                  boot.cluster = TRUE, alpha = 0.1,
                                  which.factor = c("room", "litter", "All"))
mfboot_multiple$MFhBoot$bootmfh %>% 
